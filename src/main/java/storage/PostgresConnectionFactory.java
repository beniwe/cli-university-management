...
public class PostgresConnectionFactory {
    private static final String CONNECTION_STRING = "jdbc:postgresql://localhost:5432/university_management";
    ...
    public static DSLContext build() throws SQLException {
        final var connection = DriverManager
                // TODO: try to load values from environment first and use defaults if they should not exist
